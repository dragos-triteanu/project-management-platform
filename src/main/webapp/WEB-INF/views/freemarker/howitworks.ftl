...
<html>
	<head>
	    ...
	    <link rel="stylesheet" type="text/css" href="./resources/css/mediaQueries/howitworks-media-queries.css" />
	 	
	</head>
	<body>
		<input id="userRole" type="hidden" class="hidden" value="${userRole}" />
		<@navbarRenderer.renderNavbar userRole="${userRole}" activePage="howitworks" userHasProjects=userHasProjects />
			<#if userRole == 'ADMINISTRATOR'>
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 col-xs-12">
							<form id="how-it-works-form" action="./howitworks/updatePage" method="POST" style="display:none;">
			...
			<script src="./resources/script/howitworks.js"></script>
	</body>
</html>
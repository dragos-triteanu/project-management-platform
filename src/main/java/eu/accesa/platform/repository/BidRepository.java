...
public class BidRepository {
    ...
    /**
     * Method for inserting a {@link eu.accesa.platform.model.entities.ConsultantOrder} into the 'bids' SQL schema.
     *
     * @param bid the to be added {@link eu.accesa.platform.model.entities.ConsultantOrder}.
     */

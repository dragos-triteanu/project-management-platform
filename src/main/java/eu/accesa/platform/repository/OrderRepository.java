...
import eu.accesa.platform.utils.AdminCategoryOrderSearch;
...
public class OrderRepository {
    ...
    /**
     * Method that retrieves a {@link eu.accesa.platform.model.entities.Order} from the 'orders' SQL table based on it's Id.
     *
     * @param id the id of the order.
     * @return the found {@link eu.accesa.platform.model.entities.Order}.
     */

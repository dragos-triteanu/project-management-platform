...
public class ConsultantCategoryRepository {
    ...
    /**
     *Insert  a new {@link ro.management.platform.model.entities.ConsultantSpeciality} in the 'consultant-category' DB schema.
     * @param consultantCategory the to be added {@link ro.management.platform.model.entities.ConsultantSpeciality}.
     */
    ...
    /**
     * Retrieves all {@link ro.management.platform.model.entities.ConsultantSpeciality}s in the 'consultant-category' DB schema.
     * @return
     */

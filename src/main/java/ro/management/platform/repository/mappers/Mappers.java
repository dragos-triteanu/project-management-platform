package ro.management.platform.repository.mappers;

import ro.management.platform.model.*;
...
public class Mappers {
    ...
    /**
     * Mapper class for mapping a row in the 'consultant-category' SQL schema, to a {@link ro.management.platform.model.entities.ConsultantSpeciality} object.
     *
     * @author dragos.triteanu
     */
    ...
    /**
     * Mapper class for mapping a row in the 'order' SQL schema, to a {@link ro.management.platform.model.entities.Order} object.
     */
    ...
    /**
     * Mapper class for mapping a row in the 'message' SQL schema, to a {@link ro.management.platform.model.Message} object
     */
